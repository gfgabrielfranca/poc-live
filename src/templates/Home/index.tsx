...
export function Home({ theme }: HomeProps) {
  return (
    <>
      <S.LiveBackground>
        <S.Header>
          <div>
            <Image
              src={theme.logo}
              alt="Santander" // TODO: get from theme
              width={160}
              height={28}
            />
          </div>
        ...
        <Image // TODO: replace by the live stream
      ...
      <S.LiveContent>
        <S.LeftContent>
          <h1>Investimentos: Existem oportunidades no mercado de ações neste ano?</h1>
        </S.LeftContent>
        <Image // TODO: replace by the live content
          src={theme.banner} 
          alt="banner" 
          width={358} 
          height={234}
